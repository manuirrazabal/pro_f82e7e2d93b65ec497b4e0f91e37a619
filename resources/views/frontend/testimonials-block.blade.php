...
<div class="row">
    <div class="col-sm-6">
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="{{ url('public/img/tmp/agent-1.jpg') }}" alt="">
            ...
            <div class="testimonial-inner">
                ...
                I can't say enough good things about my experience with Dana from Procor Painting ! With two small kids, a large dog and busy life, I dreaded the idea of painting, but Dana made it a pleasant experience! Professional, reliable, they use good quality no VOC paint, and got the job done quickly, so we could get back to normal. I look forward to recommending them to my friends!!

                <div class="testimonial-sign">- Kate O'Connell</div><!-- /.testimonial-sign -->
        ...
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="{{ url('public/img/tmp/agent-2.jpg') }}" alt="">
            </div><!-- /.testimonial-image -->
        ...
        <div class="testimonial last">
            <div class="testimonial-image">
                <img src="{{ url('public/img/tmp/agent-3.jpg') }}" alt="">
            </div><!-- /.testimonial-image -->
    ...
    <div class="col-sm-6">
        <div class="testimonial">
            <div class="testimonial-image">
                <img src="{{ url('public/img/tmp/agent-4.jpg') }}" alt="">
            </div><!-- /.testimonial-image -->
        ...
        <div class="testimonial last">
            <div class="testimonial-image">
                <img src="{{ url('public/img/tmp/agent-5.jpg') }}" alt="">
            </div><!-- /.testimonial-image -->
